/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d85dd0465c086be660564ad69046f3fd)
// Runtime types generated with workerd@1.20250523.0 2025-05-27 
declare namespace Cloudflare {
	interface Env {
		MATCHED_PAYLOAD_PRIVATE_KEY: string;
		GENERATED_FOR_ANDRE_FIREWALL_TEAM_PUBLIC: string;
		GENERATED_FOR_ANDRE_FIREWALL_TEAM_PRIVATE: string;
	}
}
